...
class WokDetail extends StatefulWidget {
  final Food food;

  const WokDetail({super.key, required this.food});

  @override
  State<WokDetail> createState() => _WokDetailState();
}

class _WokDetailState extends State<WokDetail> {
  int quontityCount = 0;
